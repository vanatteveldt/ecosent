...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, knit_root_dir="..", output_dir = "../../results") })
---
...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, fig.path=file.path(.project_root, "results", "figures", ""))
library(printr)
```
